...
def withdraw_money(person, money):
    if person['money'] - money >= 0:                # правка условий проверки на достаточность снятия средств
        person['money'] -= money
...
def process_user_choice(choice, person):
    if choice == 1:                                 # Исправлен тип данных на int
        print(check_account(person))
    elif choice == 2:                               # Исправлен тип данных на int
